		  ...
		  <div id="col2" class="col-sm-10 col-md-10 column" data-spy="scroll" data-target="#myNavBar" 
			 ...
			 <div id="nav" style="border-bottom: 1px solid #EEEEEE;">
				<ul class="breadcrumb">
					...
					<li>
						<a rel="nofollow" href="type_manage.jsp">主题管理</a>
					</li>
					<li class="active">
						添加主题
					</li>
			...
			<!--这里添加内容-->
			<form class="form-horizontal" action="admin/typeAdmin?method=addType" method="post">
				<div class="panel panel-default" style="margin-top:5px;width:900px;">
					<div class="panel-body">
						<div class="col-md-8 column">
							<div class="row clearfix">
								<div class="form-group">
									<label for="inputTypeName" class="col-sm-2 control-label" style="text-align: left;">主题名称
										<span style="color:#ff0000;">*</span>
									</label>
									<div class="col-sm-6">
										<input type="text" class="form-control" id="inputTypeName"
										name="typename">											
										</div>
								...
								<div class="form-group">
									<label for="inputTypeDescr" class="col-sm-2 control-label" style="text-align: left;">主题描述
									<span style="color:#ff0000;">*</span></label>
									<div class="col-sm-10">
										<textarea rows="5" cols="100" class="form-control" id="inputTypeDescr"
										name="typedescription"></textarea>
									</div>
								</div>
							</div>
							<br>
