	...
	<head>
		...
		//查询按钮点击时
		  ...
		  $( "[name='del_link']" ).click(function(){
		     ...
		     $("#deleteNoticeId").val($(this).attr("rel"));
		     $("#deleteNotice").modal();
		  });
		  
		 //模态框中的“确认删除点击时”
		   $("#deleteHaulBtn").click(function(){
		   window.location.href="<%=basePath%>admin/noticeAdmin?method=deleteNotice&noticeId="+$("#deleteNoticeId").val();
		   });
		  });
		
		  //翻页和跳页功能
		function gotoPage(currPage){
				window.location.href="<%=basePath%>admin/noticeAdmin?method=gotoNoticeManage&currPage="+currPage
	...
	<body onload="disptime()">
		...
		<div id="col2" class="col-sm-10 col-md-10 column" data-spy="scroll" data-target="#myNavBar" 
			...
			<div class="panel panel-default" style="margin-top:5px;">
				...
				<form class="form-horizontal" action="admin/noticeAdmin?method=gotoNoticeManage" method="post">
					<div class="panel-body">
						<div class="col-md-8 column">
							<div class="row clearfix">
								<div class="form-group">
									<label for="inputNoticeContent" class="col-sm-2 control-label">公告名称</label>
									<div class="col-sm-6">
			...
			<div class="panel panel-default">
					...
					<div class="row clearfix">
						...
						<div class="col-md-3 column" style="text-align: right;">
							<input type="button" value="添加" class="btn btn-default" 
								onclick="javascript:location.href='<%=basePath %>admin/noticeAdmin?method=gotoAddNotice'"
				...
				<div class="panel-body">
					<table class="table table-hover" style="margin-top:2px auto;">
						...
						<tbody>
						 <c:forEach var="notice" items="${requestScope.noticeList }" varStatus="vs">
						 
							<tr>
								<td><input type="checkbox" id="inlineCheckbox${ notice.noticeId }" 
								value="option1"></td>
								<td scope="row">${vs.count + pageData.pageSize*(pageData.currPage-1) }</td>
								<td>${ notice.noticecontent }</td>
								<td>${ notice.noticedate }</td>
								<td>
									<a href="edit_notice.jsp"><span class="fa fa-pencil-square"></span> 编辑</a> &nbsp;| &nbsp;
