                	...
                	<div class="main_content">
                        ...
                        <div class="block_home_col_1">
                        	<div class="block_home_post">
								...
								<div class="text">
									<p class="title"><a href="news_post.jsp">There are many variations of of available, but the majority.</a></p>
									<div class="date"><p>11 July, 2018</p></div>
                                    <div class="icons">
                                    	<ul>
                            ...
                            <div class="block_home_post">
								...
								<div class="text">
									<p class="title"><a href="news_post.jsp">Variations of of available, but the majority have suffered.</a></p>
									<div class="date"><p>11 July, 2018</p></div>
                                    <div class="icons">
                                    	<ul>
                            ...
                            <div class="block_home_post">
								...
								<div class="text">
									<p class="title"><a href="news_post.jsp">Majority alteration in some form, by injected humour.</a></p>
									<div class="date"><p>11 July, 2018</p></div>
                                    <div class="icons">
                                    	<ul>
                        ...
                        <div class="block_home_col_2">
                            ...
                            <div class="block_home_post">
								...
								<div class="text">
									<p class="title"><a href="news_post.jsp">Many variations of of available, but the majority.</a></p>
									<div class="date"><p>11 July, 2018</p></div>
                                    <div class="icons">
                                    	<ul>
                                        	<li><a href="#" class="views">56</a></li>
                            ...
                            <div class="block_home_post">
								...
								<div class="text">
									<p class="title"><a href="news_post.jsp">Readable content of a page when looking readable content.</a></p>
									<div class="date"><p>11 July, 2018</p></div>
                                    <div class="icons">
                                    	<ul>
                                        	<li><a href="#" class="views">74</a></li>
                            ...
                            <div class="block_home_post">
								...
								<div class="text">
									<p class="title"><a href="news_post.jsp">Randomised words which don't look even slightly believable.</a></p>
									<div class="date"><p>11 July, 2018</p></div>
                                    <div class="icons">
                                    	<ul>
                                        	<li><a href="#" class="views">88</a></li>
                        ...
                        <div class="block_topic_news">
                        	<article class="block_topic_post">
                            	<p class="title"><a href="news_post.jsp">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="news_post.jsp" class="general_pic_hover scale"><img src="images/pic_home_main_news_1.jpg" alt="" /></a></div>
                            ...
                            <article class="block_topic_post">
                            	<p class="title"><a href="news_post.jsp">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="news_post.jsp" class="general_pic_hover scale"><img src="images/pic_home_main_news_2.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2018</p></div>
                            ...
                            <article class="block_topic_post">
                            	<p class="title"><a href="news_post.jsp">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="news_post.jsp" class="general_pic_hover scale"><img src="images/pic_home_main_news_3.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2018</p></div>
                            ...
                            <article class="block_topic_post">
                            	<p class="title"><a href="news_post.jsp">Many desktop publishing packages and web page editors now use.</a></p>
                                <div class="f_pic"><a href="news_post.jsp" class="general_pic_hover scale"><img src="images/pic_home_main_news_4.jpg" alt="" /></a></div>
                                <p class="text">There are many variations of passages of available, but the majority have alteration.</p>
                                <div class="info">
                                	<div class="date"><p>11 July, 2018</p></div>
                                    ...
                                    <ul class="slides">
                                        <li>
                                            <div class="block_best_material_post">
                                                <div class="f_pic"><a href="news_post.jsp" class="w_hover"><img src="images/pic_home_best_materials_1.jpg" alt="" /><span></span></a></div>
                                                <p class="title"><a href="news_post.jsp">Publishing packages and web page editors their.</a></p>
                                                <div class="info">
                                                    <div class="date"><p>08 July, 2018</p></div>
                                                    <div class="category"><p><a href="#">Business</a></p></div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="block_best_material_post">
                                                <div class="f_pic"><a href="news_post.jsp" class="w_hover"><img src="images/pic_home_best_materials_2.jpg" alt="" /><span></span></a></div>
                                                <p class="title"><a href="news_post.jsp">Publishing packages and web page editors their.</a></p>
                                                <div class="info">
                                                    <div class="date"><p>08 July, 2018</p></div>
                                        ...
                                        <li>
                                            <div class="block_best_material_post">
                                                <div class="f_pic"><a href="news_post.jsp" class="w_hover"><img src="images/pic_home_best_materials_3.jpg" alt="" /><span></span></a></div>
                                                <p class="title"><a href="news_post.jsp">Publishing packages and web page editors their.</a></p>
                                                <div class="info">
                                                    <div class="date"><p>08 July, 2018</p></div>
                                        ...
                                        <li>
                                            <div class="block_best_material_post">
                                                <div class="f_pic"><a href="news_post.jsp" class="w_hover"><img src="images/pic_home_best_materials_4.jpg" alt="" /><span></span></a></div>
                                                <p class="title"><a href="news_post.jsp">Publishing packages and web page editors their.</a></p>
                                                <div class="info">
                                                    <div class="date"><p>08 July, 2018</p></div>
                                                    <div class="category"><p><a href="#">Business</a></p></div>
                                        ...
                                        <li>
                                            <div class="block_best_material_post">
                                                <div class="f_pic"><a href="news_post.jsp" class="w_hover"><img src="images/pic_home_best_materials_5.jpg" alt="" /><span></span></a></div>
                                                <p class="title"><a href="news_post.jsp">Publishing packages and web page editors their.</a></p>
                                                <div class="info">
                                                    <div class="date"><p>08 July, 2018</p></div>
                                                    <div class="category"><p><a href="#">People</a></p></div>
                                        ...
                                        <li>
                                            <div class="block_best_material_post">
                                                <div class="f_pic"><a href="news_post.jsp" class="w_hover"><img src="images/pic_home_best_materials_6.jpg" alt="" /><span></span></a></div>
                                                <p class="title"><a href="news_post.jsp">Publishing packages and web page editors their.</a></p>
                                                <div class="info">
                                                    <div class="date"><p>08 July, 2018</p></div>
                                                    <div class="category"><p><a href="#">Technology</a></p></div>
