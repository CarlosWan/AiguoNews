                    	...
                    	<nav class="main_menu">
                        	<ul>
								<li class="current_page_item"><a href="index.html">Home</a>
							  	...
							  	<li class="big_dropdown" data-content="lifestyle"><a href="lifestyle.html">lifestyle</a></li>
							  	<li class="big_dropdown" data-content="culture"><a href="culture.html">Culture</a></li>
                        	...
                        	<div class="content">
                                ...
                                <div class="popular_posts">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="blog_post.html"><span>01 July, 2018</span>Anything embarrassing hidden in the middl.</a></li>
                                    </ul>
                                </div>
                                <div class="line"></div>
